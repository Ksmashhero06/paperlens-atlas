        ...
        <div className="border-t border-border px-3 py-4 space-y-2">
          {isAdmin && (
            <div className="flex items-center gap-1.5">
              <Link
                to="/admin"
                className="flex flex-1 items-center gap-2 rounded-md border border-primary/30 bg-primary/10 px-2.5 py-1.5 text-xs font-semibold text-primary hover:bg-primary/20 transition-colors"
              >
          ...
          {currentUser ? (
            <div className="flex items-center gap-2 rounded-md border border-border bg-background px-2.5 py-2 text-left">
              <Link to="/settings" className="flex items-center gap-2 min-w-0 flex-1 hover:opacity-85 transition-opacity">
                {currentUser.picture ? (
                  <img
